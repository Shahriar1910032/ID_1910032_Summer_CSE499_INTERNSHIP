...
class PropertyController extends Controller
{
    ...
    public function propertyCreate()
    {
        ...
        return view('admin.property.create', compact('pageTitle', 'propertyType', 'amenities', 'activeAgent', 'states'));
    }
    ...
    public function propertyDetails($id)
    {
        ...
        return view('admin.property.edit', compact('pageTitle', 'property', 'propertyType', 'amenities', 'activeAgent', 'property_ame', 'multiImage', 'facilites', 'states'));
    }
    ...
    public function propertyMessage()
    {
        ...
        return view('admin.message.message', compact('pageTitle', 'userMessage'));
    }
    ...
    public function messageDetails($id)
    {
        ...
        $messageDetails = PropertyMessage::find($id);
        
        return view('admin.message.details', compact('pageTitle', 'messageDetails'));
    }
}
