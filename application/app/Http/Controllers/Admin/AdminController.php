...
class AdminController extends Controller
{
    ...
    public function blogComment()
    {
        ...
        return view('admin.comment.blog_comment', compact('pageTitle', 'comments'));
    }

    public function commentCheck($id)
    {
        $pageTitle = 'Blog Comment Check';
        $comments = Comment::where('id', $id)->first();

        return view('admin.comment.comment_check', compact('pageTitle', 'comments'));
    }
    ...
    public function contactMessageIndex()
    {
        ...
        return view('admin.contact.message', compact('pageTitle', 'contactMessages'));
    }

    public function viewCommentCheck($id)
    {
        $pageTitle = 'View Contact Message';
        $contactMessage = Contact::where('id', $id)->first();

        return view('admin.contact.view_message', compact('pageTitle', 'contactMessage'));
    }
}
