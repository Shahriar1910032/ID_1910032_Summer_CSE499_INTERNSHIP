...
@section('panel')
    <nav class="page-breadcrumb">
        <a href="{{ route('agent.all.property') }}" class="btn btn-inverse-warning">Property List</a>
    </nav>
    <div class="row">
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="property" action="{{ route('agent.property.update') }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select" name="state" id="exampleFormControlSelect1">
        ...
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="property" action="{{ route('agent.property.update.thumbnail') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
        ...
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="property" action="{{ route('agent.property.update.multi.image') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="submit" class="btn btn-primary btn-sm"
                                                    value="Update Image">
                                                <a href="{{ route('agent.property.update.multi.delete', $multi->id) }}"
                    ...
                    <table class="table table-striped">
                        <thead>
                            <form id="property" action="{{ route('agent.property.store.new.multi.image') }}"
        ...
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="property" action="{{ route('agent.property.update.facilites') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select name="facility_name[]" id="facility_name"
                                                        ...
                                                        <option value="Hospital"
                                                            {{ $fac->facility_name == 'Hospital' ? 'selected' : '' }}>
                                                            Hospital
                                                        </option>
                                                        <option value="SuperMarket"
                                                            {{ $fac->facility_name == 'SuperMarket' ? 'selected' : '' }}>
                                                            Super
                                                            Market</option>
                                                        <option value="School"
                                                        ...
                                                        <option value="Pharmacy"
                                                            {{ $fac->facility_name == 'Pharmacy' ? 'selected' : '' }}>
                                                            Pharmacy
                                                        </option>
                                                        <option value="Airport"
                                                            {{ $fac->facility_name == 'Airport' ? 'selected' : '' }}>
                                                            Airport
                                                        </option>
                                                        <option value="Railways"
                                                            {{ $fac->facility_name == 'Railways' ? 'selected' : '' }}>
                                                            Railways
                                                        </option>
                                                        <option value="Bus Stop"
                                                            {{ $fac->facility_name == 'Bus Stop' ? 'selected' : '' }}>Bus
                                                            Stop
                                                        </option>
                                                        <option value="Beach"
                                                        ...
                                                        <option value="Mall"
                                                            {{ $fac->facility_name == 'Mall' ? 'selected' : '' }}>Mall
                                                        </option>
                                                        <option value="Bank"
                                                            {{ $fac->facility_name == 'Bank' ? 'selected' : '' }}>Bank
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-4">
