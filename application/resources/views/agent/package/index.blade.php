...
@section('panel')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">      
            <a href="{{ route('agent.create.property') }}" class="btn btn-inverse-info btn-sm">Add Property</a>
        </ol>
    </nav>
                            ...
                            <div class="col-md-4 stretch-card grid-margin grid-margin-md-0">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-grid">
                                            <a href="{{ route('agent.buy.buisness.plan') }}" class="btn btn-success mt-4">Start Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-grid">
                                            <a href="{{ route('agent.buy.professional.plan') }}" class="btn btn-success mt-4">Start Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
