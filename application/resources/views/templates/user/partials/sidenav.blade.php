        ...
        <div class="sidebar-widget category-widget">
            ...
            <div class="widget-content">
                <ul class="category-list ">
                    ...
                    <li><a href="{{ route('compare.property') }}" target="_blank"><i class="fa fa-list-alt" aria-hidden="true"></i></i>
                            Compare </a></li>
                    <li><a href="{{ route('wishlist') }}"><i class="fa fa-indent" aria-hidden="true"></i>
                            WishList </a></li>
