                ...
                <div class="items-container row clearfix">
                    ...
                    <div
                        ...
                        <div class="place-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="{{ asset($skip_state_0->image) }}"
                    ...
                    <div
                        ...
                        <div class="place-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="{{ asset($skip_state_1->image) }}"
                                        alt="" style="width: 370px; height:275px;"></figure>
                                <div class="text">
                                    <h4><a href="{{ route('palace.details', $skip_state_3->id) }}">{{ $skip_state_1->name }}</a></h4>
                                    <p>{{ count($property_0) }} Properties</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div class="place-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="{{ asset($skip_state_2->image) }}"
                                        alt="" style="width: 370px; height:275px;"></figure>
                                <div class="text">
                                    <h4><a href="{{ route('palace.details', $skip_state_3->id) }}">{{ $skip_state_2->name }}</a></h4>
                    ...
                    <div
                        ...
                        <div class="place-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="{{ asset($skip_state_3->image) }}"
                                        alt="" style="width: 770px; height:275px;"></figure>
                                <div class="text">
                                    <h4><a href="{{ route('palace.details', $skip_state_3->id) }}">{{ $skip_state_3->name }}</a></h4>
