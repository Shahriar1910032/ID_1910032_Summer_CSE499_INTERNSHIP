@extends(view: 'templates.layouts.frontend')
@section('master')
    <!--Page Title-->
                ...
                <div class="agents-block-one">
                    <div class="inner-box mr-0">
                        <figure class="image-box"><img
                                src="{{ !empty($agent->image) ? url('application/public/upload/agent/' . @$agent->image) : url('application/public/upload/no_image.jpg') }}"
                        ...
                        <div class="content-box">
                            ...
                            <ul class="info clearfix mr-0">
                                <li><i class="fab fa fa-envelope"></i><a
                                        href="mailto:info@realhome.com">{{ $agent->email }}</a></li>
                                                ...
                                                <div class="feature-block-one">
                                                    <div class="inner-box">
                                                        ...
                                                        <div class="lower-content">
                                                            ...
                                                            <div class="title-text">
                                                                <h4><a href="property-details.html">The Citizen
                                                                        Apartment</a></h4>
                                                            </div>
                                                            <div class="price-box clearfix">
                                                                <div class="price-info pull-left">
                                                ...
                                                <div class="feature-block-one">
                                                    <div class="inner-box">
                                                        ...
                                                        <div class="lower-content">
                                                            ...
                                                            <div class="title-text">
                                                                <h4><a href="property-details.html">Cottage Woods House</a>
                                                                </h4>
                                                            </div>
                                                            <div class="price-box clearfix">
                                                                <div class="price-info pull-left">
                        ...
                        <div class="agents-contact sidebar-widget">
                            ...
                            <div class="form-inner">
                                @auth
                                    ...
                                    <form action="{{ route('agent.message') }}" method="post" class="default-form">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <input type="tel" name="phone" placeholder="Phone" required="" value="{{ $userData->phone }}" >
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="category-widget sidebar-widget">
                                ...
                                <ul class="category-list clearfix">
                                    <li><a href="{{ route('all.rent.property') }}">For Rent <span>({{ count($rentProperty) }})</span></a></li>
                                    <li><a href="{{ route('all.buy.property') }}">For Buy <span>({{ count($buyProperty) }})</span></a></li>
                                </ul>
                            </div>
                                ...
                                <div class="single-item-carousel owl-carousel owl-theme owl-nav-none dots-style-one">
                                    @foreach ($featured as $data)
                                        <div class="feature-block-one">
                                            <div class="inner-box">
                                                <div class="image-box">
                                                    <figure class="image"><img src="{{ asset($data->thumbnail) }}"
                                                ...
                                                <div class="lower-content">
                                                    <div class="title-text">
                                                        <h4><a href="property-details.html">{{ $data->name }}</a></h4>
                                                    </div>
                                                    <div class="price-box clearfix">
                                                        <div class="price-info">
                                                            <h6>Start From</h6>
                                                            <h4>${{ $data->lower_price }}.00</h4>
                                                        </div>
                                                    </div>
                                                    <p>{{ $data->short_desc }}</p>
                                                    <div class="btn-box"><a
                                                            href="{{ route('property.details', ['slug' => $data->slug]) }}"
                                                            class="theme-btn btn-two">See Details</a></div>
                                                </div>
                                            </div>
                                        </div>
