                                ...
                                <ul class="nav flex-column">
                                    <li class="nav-item active">
                                        <a class="nav-link d-flex align-items-center" href="../email/inbox.html">
                                            ...
                                            Inbox
                                            <span class="badge bg-danger fw-bolder ms-auto">{{ count($userMessage) }}
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-6">
                                        <div class="d-flex align-items-end mb-2 mb-md-0">
                                            ...
                                            <span class="text-muted">({{ count($userMessage) }} new messages)</span>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                            ...
                            <div class="email-list">
                                ...
                                @foreach ($userMessage as $message)
                                    <div class="email-list-item email-list-item--unread">
                                        ...
                                        <a href="{{ route('admin.property.message.details', $message->id) }}" class="email-list-detail">
                                            <div class="content">
                                                <span class="from">{{ $message['user']['name'] }}</span>
                                                <p class="msg">{{ $message->message }}</p>
                                            </div>
                                            <span class="date">
                                                {{ $message->created_at->format('l  d M') }}
                                            </span>
                                        </a>
                                    </div>
                                @endforeach
