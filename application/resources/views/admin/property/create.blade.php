        ...
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="property" action="{{ route('admin.property.store') }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="file" name="image[]" class="form-control" id="multiImg" multiple="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="bathrooms" class="form-control" {{ old('bathrooms') }}>
                                </div>
                            </div><!-- Col -->
                            <div class="col-sm-3">
                                <div class="form-group mb-3">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group mb-3">
                                ...
                                <textarea name="long_desc" class="form-control" id="summernote">{{ old('long_desc') }}</textarea>
                            </div>
                        </div><!-- Col -->
