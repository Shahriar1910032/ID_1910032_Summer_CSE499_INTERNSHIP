        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="myForm" action="{{ route('admin.blog.store') }}" method="POST" enctype="multipart/form-data" class="forms-sample">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control" name="meta_description" id="exampleFormControlTextarea1" rows="5">{{ old('meta_description') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <img src="" alt="" id="mainThmb" class="wd-80 rounded-circle">
                            </div><!-- Col -->
